...
const Profile = () => {
    ...
    const [bookings, setBookings] = useState([{ id: "", room: { id: "", roomType: "", }, checkInDate: "", checkOutDate: "", bookingConfirmationCode: "", }])
    ...
    const handleDeleteAccount = async () => {
        const confirmed = window.confirm("Bạn có chắc rằng bạn muốn xóa tài khoản của bạn? Hành động này không thể được hoàn tác.")
        if (confirmed) {
                ...
                <div className="card p-5 mt-5" style={{ backgroundColor: "whitesmoke" }}>
                    ...
                    <div className="card-body">
                        <div className="col-md-10 mx-auto">
                            ...
                            <h4 className="card-title text-center">Lịch sử đặt chỗ</h4>

                            {bookings.length > 0 ? (
                                <table className="table table-bordered table-hover shadow">
                                    <thead>
                                        <tr>
                                            <th scope="col">ID đặt chỗ</th>
                                ...
                                <p>Bạn chưa thực hiện bất kỳ đặt chỗ nào.</p>
                            )}
