...
import com.example.summerhotel.exception.PhotoRetrievalException;
...
import com.example.summerhotel.response.BookingResponse;
import com.example.summerhotel.response.RoomResponse;
import com.example.summerhotel.service.impl.BookingServiceImpl;
    ...
    private RoomResponse getRoomResponse(Room room) {
        ...
        if(photoBlob != null){
            try {
                ...
                throw new PhotoRetrievalException("Lỗi khi truy xuất ảnh");
            }
        }
